...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Feedback.browser'
        db.alter_column(u'feedback_feedback', 'browser', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'AnonymousFeedback.browser'
        db.alter_column(u'feedback_anonymousfeedback', 'browser', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'feedback.anonymousfeedback': {
            ...
            'browser': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
